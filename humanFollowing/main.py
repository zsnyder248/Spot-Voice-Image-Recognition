...
from human_follower2 import ObjectTracker
...
# Begin following a person using cameras
@app.route('/BeginCameraFollowing')
def beginFollowing():
    global activeAPI, activeTracker
    activeTracker = ObjectTracker('person', activeAPI)
    return flask.jsonify("HI")


# End following a person and have Spot stand in place
@app.route('/EndCameraFollowing')
def endFollowing():
    global activeAPI, activeTracker
